...
const EditInvPharmacy = ({ isOpenEdit, closeModalEdit, title }) => {
  return (
    <div>
      ...
      <form>
          ...
          <div  className="flex gap-2 flex-col">
            <Label htmlFor="Name"> Pharmacy Id : </Label>
            <Input id="Name"/>
          </div>
          <div  className="flex gap-2 flex-col">
            <Label htmlFor="Phone"> Pharmacy Name : </Label>
            <Input id="Phone"/>
          </div>
          <div  className="flex gap-2 flex-col">
...
export default EditInvPharmacy;
